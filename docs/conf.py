...
latex_documents = [
    (master_doc, 'honeybee-ies.tex', 'honeybee-ies Documentation',
...
man_pages = [
    (master_doc, 'honeybee-ies', 'honeybee-ies Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'honeybee-ies', 'honeybee-ies Documentation',
     author, 'honeybee-ies', 'One line description of project.',
     'Miscellaneous'),
]
